...
export default function Locations() {
  ...
  return (
    <section className="flex flex-col  items-center" id="about">
      <SectionTitle title="Opening soon at Faisalabad’s most connected locations." />
        ...
        {sectionData.map((data, index) => (
          ...
          >
            ...
            <div className="mt-5 space-y-2">
              <h3 className="text-base flex gap-2 font-medium text-slate-200">
                {data.title}
                {data.title === "WAPDA City" && (
                  <span className="inline-block bg-indigo-900 text-indigo text-xs px-2 py-1 rounded-full">
                    Currently Available
                  </span>
                )}
              </h3>
